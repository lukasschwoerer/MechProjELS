...
MODEL                = RealTimeMachine
MODULES              = RealTimeMachine.c RealTimeMachine_capi.c c_mexapi_version.c
PRODUCT              = RealTimeMachinelib.lib
...
MODELLIB                  = RealTimeMachinelib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = RealTimeMachine_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/RealTimeMachine \
